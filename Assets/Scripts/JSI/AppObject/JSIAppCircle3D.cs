...
namespace JSI.AppObject
{
    ...
    {
        // constants
        public static readonly int NUM_SIDE = 32;
        ...
        // constructor
        public JSIAppCircle3D(string name, float radius, Color color) : base($"{name}/Circle3D")
        {
            this.mGeom = new JSICircle3D(radius, Vector3.zero, Quaternion.identity);
            this.mColor = color;
            this.refreshAtGeomChange();
        }
        ...
        protected override void refreshRenderer()
        {
            ...
            mf.mesh = circle.calcMesh(NUM_SIDE);
