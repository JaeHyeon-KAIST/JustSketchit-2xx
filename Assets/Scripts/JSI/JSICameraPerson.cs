...
namespace JSI
{
    public abstract class JSICameraPerson
    {
        ...
        public JSICameraPerson(string name)
        {
            ...
            this.mCamera = this.mCameraRig.getGameObject().GetComponent<Camera>();
        ...
        {
            this.mCameraRig.getGameObject().transform.rotation = Quaternion.LookRotation(view, Vector3.up);
        }
